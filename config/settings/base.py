...
ROOT_DIR = environ.Path(__file__) - 3  # (pay_demo/config/settings/base.py - 3 = pay_demo/)
APPS_DIR = ROOT_DIR.path('pay_demo')
...
MIGRATION_MODULES = {
    'sites': 'pay_demo.contrib.sites.migrations'
}
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['pay_demo.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'pay_demo.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
